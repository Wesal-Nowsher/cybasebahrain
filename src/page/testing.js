...
//             </div>
//             <div className="row">
//                 <div className="col-4 secon-row-text d-flex flex-column align-items-center">
                      
//                     <h2>{  data && data.header && data.header.h2&& data.header.h2}</h2>
//                     <p>
//                     {  data && data.header && data.header.p&& data.header.p}
//                     </p>
//                     <button className="btn"><a href="https://registration.cybasebahrain.com/auth/user-registration"> {  data && data.header && data.header.buttons&& data.header.buttons}</a></button>
//                     <div className="android-apple">
//                         <ul>
//                             <li className="android-applae android ">
//                               <a href="https://play.google.com/store/apps/details?id=com.cyberspace.cybasebh"><i className="fa fa-android"></i></a></li>
//                             <li className="android-applae apple"><a href="https://apps.apple.com/ca/app/cybase-bahrain/id1605718536"><i className="fa fa-apple"></i></a></li>
//                         </ul>
//                     </div>
//                 </div>
//                 <div className="col-8 analytics-img position-relative">
...
//           {
//             console.log(showfeature ===  `${data && data.featuresarea && data.featuresarea.upperhead&& data.featuresarea.upperhead[0]}`,showfeature)
//           }
//             <div className={`col-4 single-amine ${showfeature ===  `${data && data.featuresarea && data.featuresarea.upperhead&& data.featuresarea.upperhead[0]}` ? "first-orange":""}`} onMouseOver={()=> {setFeatureoff(`${data && data.featuresarea && data.featuresarea.upperhead&& data.featuresarea.upperhead[0]}`)}} >
...
//             </div>
//             <div  className={`col-4 single-amine ${showfeature ===  `${data && data.featuresarea && data.featuresarea.upperhead&& data.featuresarea.upperhead[1] }` ? "first-orange":""}`}  onMouseOver={()=> {setFeatureoff(`${data && data.featuresarea && data.featuresarea.upperhead&& data.featuresarea.upperhead[1]}`) }}>
...
//     </div>
// </section>
// <section className="features" style={{direction:`${direction}`}}>
//     <div className="container">
//       { showfeature ===  `${data && data.featuresarea && data.featuresarea.upperhead&& data.featuresarea.upperhead[0]}` &&
//         <div className="row ">
...
//                 </p>
//                 <button className="btn"> <NavLink to="/manageyourteam">
...
//        { showfeature === `${data && data.featuresarea && data.featuresarea.upperhead&& data.featuresarea.upperhead[1]}`&&
//         <div className="row">
//             <div className="col-6 extra-pad   d-flex flex-column align-items-center justify-content-center">
//             <div className="secon-row-text p-0">.
...
//                </p>
//                <button className="btn"> <NavLink to="/organizeyourprojects">
...
//         { showfeature ===  `${data && data.featuresarea && data.featuresarea.upperhead&& data.featuresarea.upperhead[2]}` &&
//         <div className="row">
...
//                </p>
//                <button className="btn"> <NavLink to="/organizecommunications">
...
//           { showfeature ===  `${data && data.featuresarea && data.featuresarea.upperhead && data.featuresarea.upperhead[3]}`&&
//         <div className="row">
//             <div className="col-6 extra-pad  d-flex flex-column align-items-center justify-content-center">
//             <div className="secon-row-text p-0">.
...
//                </p>
//                <button className="btn"> <NavLink to="/clientorganizations">
...
//           { showfeature ===  `${data && data.featuresarea && data.featuresarea.upperhead && data.featuresarea.upperhead[4]}`&&
//         <div className="row">
...
//                </p>
//                <button className="btn"> <NavLink to="/analyticaldashboard">
...
//     <div className="container-fluid pricingplanhead positoin-relative " id="plans">
...
//                             />
//                                 <h5>{item.place}</h5>
//                             <p className="dtr-price ">{item.price}</p>
        
//                                 <p className="dtr-m-0 color-white">{item.employees}</p>
//                             <a href="https://registration.cybasebahrain.com/auth/user-registration" className="dtr-btn  dtr-my-30">{item.button}</a>
//                             <p className="text-size-md font-weight-600  d-no-res">{item.updates}</p>
...
//                     { data && data.gettingstarted && data.gettingstarted.p && data.gettingstarted.p }
                        
//                     </p>
//                     <a href="#" className="dtr-btn  dtr-mt-20">{ data && data.gettingstarted && data.gettingstarted.buttons && data.gettingstarted.buttons }</a>
//                 </div>
...
//                <img src={require(`../assets/contact us.png`).default} className="w-90" />
//                </div>
...
//                     <form id="contactform" method="post" action="php/contact-form-short.php" novalidate="novalidate">
//                         <fieldset>
...
//                             </p>
//                             <p className="dtr-m-0">
//                                 <button className="dtr-btn btn-dark-blue" type="submit">{data && data.contact && data.contact.button && data.contact.button}</button>
//                             </p>
//                             <div id="result"></div>
//                         </fieldset>
//                     </form>
